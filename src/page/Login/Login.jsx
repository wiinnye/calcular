    ...
    <>
      ...
      >
          <Flex
            ...
            bg="#fff"
            borderRadius={"25px"}
            boxShadow="2px 2px 3px 3px #ffe77c"
          >
            {/* Cabeçalho */}
            <Flex
            ...
            >
              ...
              <Text paddingBottom={{ lg: "1rem" }} color="#000" textAlign='center' fontSize='3xl'>
                Trigger Informática
              </Text>
            </Flex>
            ...
            <Flex direction="column" mb="1rem">
              ...
              <Input
                ...
                padding=".5rem"
                borderColor={erroEmail || error ? "red.400" : "#000"}
                value={emailValue}
            ...
            >
              <Text fontSize="14px" color="#4A5568" mb="4px">
                ...
                <Input
                  ...
                  w={{ base: "200px", md: "250px", lg: "350px" }}
                  padding=".5rem"
                  borderColor={erroSenha || error ? "red.400" : "#000"}
                  borderRight='none'
                  _hover={{ borderRight:'none'}}
                  value={senhaValue}
